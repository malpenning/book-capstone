...
data <- rio::import(here::here("capstone/final.csv"))
tabtime <- rio::import(here::here("capstone/tabtime.csv"))
coef_tab <- rio::import(here::here("capstone/coef_tab.csv"))
confusion_ridge <- rio::import(here::here("capstone/confusion_ridge.csv"))
readdata <- rio::import(here::here("capstone/readdata.csv"))
```
...
Then, utilize the files in this **Github repo**:
